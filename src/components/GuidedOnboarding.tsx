...
const steps: OnboardingStep[] = [
  ...
  },
  {
    ...
    eyebrow: 'Step 3',
    title: 'Generate your ML price',
    body: 'Tap Get recommendation. When the pricing card appears, VoltShare has calculated your ML-optimised listing price and expected earnings.',
    cta: 'Continue',
    mode: 'action',
