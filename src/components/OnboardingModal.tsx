...
const steps = [
  {
    ...
    body: 'VoltShare is a peer-to-peer renewable energy platform. You can list surplus solar energy for sale, or buy clean energy from households nearby — with smarter pricing built in.',
    cta: 'Show me how',
  },
  {
    icon: BarChart3,
    ...
    body: 'The Analytics Dashboard explains how VoltShare builds its recommendation from real energy datasets. It walks through demand modelling, supply proxies, and the price optimisation logic — no sign-in needed.',
    cta: 'Got it',
  },
  {
    icon: Sparkles,
    ...
    body: 'Once signed in, every sale you confirm is saved to your account. Your trading history refreshes each month so you can see how your energy earnings grow over time.',
    cta: "Let's start",
  },
] as const;
